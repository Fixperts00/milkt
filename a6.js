...
const additionalNotes = {
  1: { // 런처 설치
    ...
    20: "밀크T와 함께해주셔서 감사합니다. 만약 설치 진행이 어려우시거나 정상적으로 설치가 되지 않는 경우에는, <br><span style='color: #dc3545; font-weight: bold; display: block;'>담당 선생님 혹은 밀크T 고객센터로 연락 부탁드립니다.</span>"
  }
};
